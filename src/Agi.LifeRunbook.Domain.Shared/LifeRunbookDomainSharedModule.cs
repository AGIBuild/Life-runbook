...
public class LifeRunbookDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        LifeRunbookGlobalFeatureConfigurator.Configure();
        LifeRunbookModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<LifeRunbookDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<LifeRunbookResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/LifeRunbook");

            options.DefaultResourceType = typeof(LifeRunbookResource);
        ...
        {
            options.MapCodeNamespace("LifeRunbook", typeof(LifeRunbookResource));
        });
    }
}
